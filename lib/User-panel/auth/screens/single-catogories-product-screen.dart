...
import 'package:shopping/User-panel/auth/screens/product-detail-screen.dart';
import 'package:shopping/User-panel/models/product-model.dart';
    ...
    return Scaffold(
      ...
      body: FutureBuilder(
        future: FirebaseFirestore.instance
            .collection('products')
            .where('categoriesId', isEqualTo: widget.categoryId)
            .get(),
